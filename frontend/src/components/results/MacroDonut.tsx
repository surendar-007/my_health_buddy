      ...
      {preset === "custom" && (
        ...
        <div className="space-y-4 rounded-3xl bg-surface-raised p-4">
          ...
          <p className="text-xs text-muted">
            Adjust one macro; the other two
            rebalance automatically to total 100%.
          </p>
              ...
              return (
                ...
                >
                  ...
                  <input
                    ...
                    style={
                      {
                        "--macro-color": COLORS[key],
                        "--slider-progress": `${
                          (
                            (distribution[key] - min) /
                            (max - min)
                          ) * 100
                        }%`,
